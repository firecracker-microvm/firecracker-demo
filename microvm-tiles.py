...
def render_microvms(stdscr):
    ...
    # Initialize 100 color pairs from dark grey to Amazon orange.
    # Color pair `:w is reserved in curses, we'll start from 1.
    ...
    while True:
        ...
        with open('/proc/net/dev') as net_iface_list:
            ...
            for iface_line in net_iface_list:
                # TODO: Only operate microMV tun/tap lines
